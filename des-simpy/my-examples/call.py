...
def customer(env, name, call_center):
    ...
    print(f'Custommer {name} enters waiting queue at {env.now:.2f}!')
...
print('Starting call center: ')
env = simpy.Environment()
env.process(setup(env, NUM_EMPLOYEES, AVG_SUPPPORT_TIME, CUSTOMER_INTERVAL))
